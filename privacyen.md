...
OTTERWORKS provides multiple services including the Strapion app (Ad Supported) and SuitAI (AI-powered professional photo generation). These services are provided by OTTERWORKS and are intended for use as is.
...
#### Strapion:
Does not use cookies explicitly, but may use third-party code and libraries that use cookies.

#### SuitAI:
Uses essential cookies for authentication, session management, and security purposes.
